...
- A **library** is a `DEFINITION MODULE` (`.def` — the public interface) plus an
  ...
  exports. See [Modules & compilation](modules-and-compilation.md).
...
---
[NewM2 Guide home](index.md) · [Lexical structure](lexical-structure.md) · [Modules & compilation](modules-and-compilation.md)
