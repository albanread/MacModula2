...
shouldn't) declare a local `INTEGER`. See [Lexical structure](lexical-structure.md) for
...
[Memory & exceptions](memory-and-exceptions.md).
...
See [Modules & compilation](modules-and-compilation.md) for how the definition and
implementation module pair interact.

---
[NewM2 Guide home](index.md) · [Lexical structure](lexical-structure.md) · [Expressions & operators](expressions-and-operators.md) · [Modules & compilation](modules-and-compilation.md)
