...
`NEW` and `DISPOSE` are covered in depth in [Memory & exceptions](memory-and-exceptions.md).
...
---
[NewM2 Guide home](index.md) · [Declarations & types](declarations-and-types.md) · [Memory & exceptions](memory-and-exceptions.md)
